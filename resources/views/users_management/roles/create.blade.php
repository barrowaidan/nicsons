<div class="modal fade" id="kt_modal_add_role" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
                                            ...
                                            <td>
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <label class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
                                                        <input class="form-check-input" type="checkbox" value="{{ $permission->name }}" name="permission[{{ $permission->name }}]" />
