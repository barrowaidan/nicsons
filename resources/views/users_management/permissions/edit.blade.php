<div class="modal fade" id="kt_modal_update_permission" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <!--end::Notice-->
                <!--begin:: Validation-->
                <div id="update_validation_errors"></div>
                    <!--end:: Validation-->
                <!--begin::Form-->
                <form id="kt_modal_update_permission_form" class="form" action="#">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input class="form-control form-control-solid" placeholder="Enter a permission name" id="p_name" name="permission_name" />
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                    <!--begin::Actions-->
                    <div class="text-center pt-15">
                        ...
                        <button type="submit" id="submit_permision_update" class="btn btn-primary" data-kt-permissions-modal-action="submit">
