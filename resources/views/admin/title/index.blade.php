                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                                ...
                                                <div class="menu-item px-3">
                                                        <a href="" class="menu-link px-3" data-bs-toggle="modal" id="{{$title->id}}" onclick="gettitleEditData(this)" data-bs-target="#kt_modal_edit_company">Edit</a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <!--begin::Menu item-->
...
<script src="{{ asset('style/js/custom/apps/title/add.js')}}"></script>
<script src="{{ asset('style/js/custom/apps/title/edit.js')}}"></script>
<script src="{{ asset('style/js/custom/apps/title/table.js')}}"></script>