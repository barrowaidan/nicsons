...
<div class="modal-dialog modal-dialog-centered mw-650px">
    ...
    <div class="modal-content">
        ...
        <div class="modal-header">
            <!--begin::Modal title-->
            <h2 class="fw-bolder">Edit Event Details</h2>
            <!--end::Modal title-->
            <!--begin::Close-->
                ...
                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_company_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <div class="image-input image-input-outline" data-kt-image-input="true"  style="background-image: url({{ asset('style/media/avatars/blank.png') }})">
                                ...
                                <div class="image-input-wrapper w-125px h-125px" id="edit_event_image" ></div>
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" id="edit_event_name" name="name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder=" name"/>
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <textarea name="text" id="edit_event_text" cols="4" rows="2" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Text"></textarea>
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
