        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
            ...
            <div class="flex-grow-1 flex-shrink-0 me-5">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Team</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center">
                                            ...
                                            <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                <a href="#">
                                                    <div class="symbol-label">
                                                        ...
                                                        <img src="{{ asset('assets/img/' . $team->image) }}" alt="image" class="w-100" />
                                                        @else
                                                        <img src="{{ asset('style/media/avatars/blank.png') }}" alt="image" class="w-100" />
                                                        @endif
                                                    </div>
                                                </a>
                                            </div>
                                            ...
                                            <div class="d-flex flex-column">
                                                <a href="#" class="text-gray-800 text-hover-primary mb-1">{{$team->name}}</a>
                                        ...
                                        <!--begin::Last login=-->
                                        <td >
                                        {!! Setting::getUserRoleName($team->id) !!}
                                        </td>
                                        <!--end::Last login=-->
                                        <!--begin::Action=-->
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                                ...
                                                <div class="menu-item px-3">
                                                        <a href="" class="menu-link px-3" data-bs-toggle="modal" id="{{$team->id}}" onclick="getteamEditData(this)" data-bs-target="#kt_modal_edit_company">Edit</a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a href="" class="menu-link px-3" data-bs-toggle="modal" onclick="getmediaEditData({{$team->id}})" data-bs-target="#add_social_media">Add Media</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item -->
                                                <div class="menu-item px-3">
...
<script src="{{ asset('style/js/custom/apps/teams/add_media.js')}}"></script>
<script src="{{ asset('style/js/custom/apps/teams/add.js')}}"></script>
<script src="{{ asset('style/js/custom/apps/teams/edit.js')}}"></script>
<script src="{{ asset('style/js/custom/apps/teams/table.js')}}"></script>