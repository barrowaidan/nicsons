        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
            ...
            <div class="flex-grow-1 flex-shrink-0 me-5">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">FAQs</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                                ...
                                                <div class="menu-item px-3">
                                                        <a href="" class="menu-link px-3" data-bs-toggle="modal" id="{{$service->id}}" onclick="getfaqsEditData(this)" data-bs-target="#kt_modal_edit_company">Edit</a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <!--begin::Menu item -->
...
<script src="{{ asset('style/js/custom/apps/faqs/add.js')}}"></script>
<script src="{{ asset('style/js/custom/apps/faqs/edit.js')}}"></script>
<script src="{{ asset('style/js/custom/apps/faqs/table.js')}}"></script>