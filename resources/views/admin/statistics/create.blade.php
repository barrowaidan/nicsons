    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header" id="kt_modal_add_user_header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder">Add Statistics Details</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
                ...
                <form id="kt_modal_add_company_form" class="form" action="#" autocomplete="off">
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_company_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_company_header" data-kt-scroll-wrappers="#kt_modal_add_company_scroll" data-kt-scroll-offset="300px">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <textarea name="text" cols="4" rows="2" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="text"></textarea>
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="number" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="number"/>
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                    </div>
