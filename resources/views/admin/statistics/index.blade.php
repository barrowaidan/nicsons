        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
            ...
            <div class="flex-grow-1 flex-shrink-0 me-5">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Statistics</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        @include('admin.Statistics.create')
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            @if(!is_null($statistics))
                                ...
                                @foreach ($statistics as $statistic)
                                    <tr>
                                        <!--begin::Cell=-->
                                        <td style="display:none;">{{$statistic->id}}</td>
                                        <!--end::Cell=-->
                                        <!--begin::Checkbox-->
                                        <td>
                                            {{ $i++ }}
                                            ...
                                            <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                <a href="#">
                                                    <div class="symbol-label">
                                                        <img src="{{ asset('assets/img/' . $statistic->photo[0]->img_path) }}" alt="event" class="w-100" />
                                                    </div>
                                                </a>
                                            </div>
                                            <!--end::Avatar-->
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                                ...
                                                <div class="menu-item px-3">
                                                        <a href="" class="menu-link px-3" data-bs-toggle="modal" id="{{$statistic->id}}" onclick="getStatisticsEditData(this)" data-bs-target="#kt_modal_edit_company">Edit</a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <!--begin::Menu item -->
...
<script src="{{ asset('style/js/custom/apps/statistics/add.js')}}"></script>
<script src="{{ asset('style/js/custom/apps/statistics/edit.js')}}"></script>
<script src="{{ asset('style/js/custom/apps/statistics/table.js')}}"></script>