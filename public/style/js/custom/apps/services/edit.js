...
function getserviceEditData(element) {
    $(document).ready(function(){
        ...
        $.ajax({
            ...
            success:function(response){
                ...
                document.getElementById('service_image').setAttribute('style', imageUrl);
                document.getElementById('edit_service_name').value = response.service.name;
                document.getElementById('edit_service_text').value = response.service.text;

                document.getElementById('submit_company_update').setAttribute('value', response.service.id);
                },
            error:function(){
