...
function gettitleEditData(element) {
    $(document).ready(function(){
        ...
        $.ajax({
            ...
            success:function(response){
                document.getElementById('title_name').setAttribute('value', response.title.title);

                document.getElementById('submit_company_update').setAttribute('value', response.title.id);
                },
            error:function(){
