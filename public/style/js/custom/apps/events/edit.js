...
function geteventEditData(element) {
    $(document).ready(function(){
        ...
        $.ajax({
            ...
            success:function(response){
                ...
                document.getElementById('edit_event_image').setAttribute('style', imageUrl);
                document.getElementById('edit_event_name').value = response.event.name;
                document.getElementById('edit_event_text').value = response.event.text;

                document.getElementById('submit_company_update').setAttribute('value', response.event.id);
                },
            error:function(){
