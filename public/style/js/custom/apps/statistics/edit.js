...
function getStatisticsEditData(element) {
    $(document).ready(function(){
        let id = element.id;
        $.ajax({
            type:"get",
            url:"statistical/" + id + "/edit",
            cache:false,
            dataType:false,
            processData:false,
            success:function(response){
                ...
                document.getElementById('Statistics_image').setAttribute('style', imageUrl);
                document.getElementById('edit_Statistics_number').value = response.statistics.number;
                document.getElementById('edit_Statistics_text').value = response.statistics.text;

                document.getElementById('submit_company_update').setAttribute('value', response.statistics.id);
                },
            error:function(){
