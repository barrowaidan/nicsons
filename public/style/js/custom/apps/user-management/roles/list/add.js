...
function makeRequest() {
    let t = document.querySelector('#kt_modal_add_role');
    let form = new FormData(t.querySelector('#kt_modal_add_role_form'));
                    ...
                    r.addEventListener("click",(function(t){
                        ...
                        o&&o.validate().then((function(t){
                            ...
                            setTimeout((function(){
                                ...
                                r.disabled=!1,
                                $.when(makeRequest().then(function successHandler(response){
