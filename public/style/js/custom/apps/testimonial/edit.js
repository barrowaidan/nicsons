...
function gettestimonialEditData(element) {
    $(document).ready(function(){
        ...
        $.ajax({
            ...
            success:function(response){
                ...
                document.getElementById('edit_testimonial_name').value = response.testimonials.name;
                document.getElementById('edit_testimonial_title').value = response.testimonials.title;
                document.getElementById('edit_testimonial_text').value = response.testimonials.text;
                document.getElementById('submit_company_update').setAttribute('value', response.testimonials.id);
                let imageUrl = "background-image: url(http://127.0.0.1:8000/assets/img/" + response.photo[0].img_path + ");";
                console.log(imageUrl);
                document.getElementById('testimonial_image').setAttribute('style', imageUrl);
            },
            error:function(){
